...
for (const f of ['wordlist', 'format', 'crypto', 'generate']) {
...
await rejects('rejects downgraded KDF params', b => new DataView(b.buffer).setUint32(10, 1000));
...
const fast = { ...LV.crypto.DEFAULT_PARAMS, iterations: 1 };
